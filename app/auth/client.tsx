...
export default function Client({ redirectTo, flashStatus, flashMessage }: ClientProps) {
  ...
  const content = useMemo(() => {
    if (mode === "signup") {
      return {
        id: "signup",
        title: "Create your BrewCRM account",
        description: "Don’t have an account? Get started with BrewCRM and build your shop’s community.",
      };
    }
    return {
      id: "signin",
      title: "Sign in to BrewCRM",
      description:
        "Welcome back to BrewCRM. Please sign in to manage your coffee shop’s customers and loyalty.",
    };
  }, [mode]);
          ...
          <div className="relative z-10 flex h-full flex-col justify-between">
            <div className="space-y-4">
              ...
              <h1 className="max-w-sm text-4xl font-semibold leading-tight tracking-tight">
                The CRM made for coffee shops.
              </h1>
              <p className="max-w-md text-sm text-muted-foreground">
                Sign in to manage customers, loyalty, and your shop’s community — all in one workspace.
              </p>
            </div>
                ...
                <form className="space-y-4" action={signUpAction}>
                  ...
                  <div className="grid gap-4 sm:grid-cols-2">
                    <div className="space-y-2">
                      ...
                      <Input id="signup-first-name" name="firstName" placeholder="Alex" required />
                    </div>
                    <div className="space-y-2">
                      <Label htmlFor="signup-last-name">Last name</Label>
                      <Input id="signup-last-name" name="lastName" placeholder="Wong" required />
                    </div>
                  </div>
                  <div className="space-y-2">
